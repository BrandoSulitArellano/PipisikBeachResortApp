...
@Component({
  selector: 'app-ka1',
  templateUrl: './ka1.page.html',
  styleUrls: ['./ka1.page.scss'],
})
export class KA1Page implements OnInit {
  ...
  confirm(){
    ...
    if(this.araw.days == 0){
      ...
      this.text1 = 'Your reservation for Karla is now processing, wait for our staff to call your provided number for verification. Thank You for trusting us.';
