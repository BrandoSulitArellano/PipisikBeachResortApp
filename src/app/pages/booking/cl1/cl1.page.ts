...
@Component({
  selector: 'app-cl1',
  templateUrl: './cl1.page.html',
  styleUrls: ['./cl1.page.scss'],
})
export class CL1Page implements OnInit {
  ...
  confirm(){
    ...
    if(this.araw.days == 0){
      ...
      this.text1 = 'Your reservation for Crystal is now processing, wait for our staff to call your provided number for verification. Thank You for trusting us.';
