...
@Component({
  selector: 'app-klup',
  templateUrl: './klup.page.html',
  styleUrls: ['./klup.page.scss'],
})
export class KLUPPage implements OnInit {
  ...
  confirm(){
    ...
    if(this.araw.days == 0){
      ...
      this.text1 = 'Your reservation for KL-UP is now processing, wait for our staff to call your provided number for verification. Thank You for trusting us.';
