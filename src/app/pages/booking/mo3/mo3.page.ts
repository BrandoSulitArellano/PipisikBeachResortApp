...
@Component({
  selector: 'app-mo3',
  templateUrl: './mo3.page.html',
  styleUrls: ['./mo3.page.scss'],
})
export class MO3Page implements OnInit {
  ...
  confirm(){
    ...
    if(this.araw.days == 0){
      ...
      this.text1 = 'Your reservation for Mhyko 3 is now processing, wait for our staff to call your provided number for verification. Thank You for trusting us.';
