...
@Component({
  selector: 'app-bo1',
  templateUrl: './bo1.page.html',
  styleUrls: ['./bo1.page.scss'],
})
export class BO1Page implements OnInit {
  ...
  confirm(){
    ...
    if(this.araw.days == 0){
      ...
      this.text1 = 'Your reservation for Brando is now processing, wait for our staff to call your provided number for verification. Thank You for trusting us.';
