...
@Component({
  selector: 'app-my1',
  templateUrl: './my1.page.html',
  styleUrls: ['./my1.page.scss'],
})
export class MY1Page implements OnInit {
  ...
  confirm(){
    ...
    if(this.araw.days == 0){
      ...
      this.text1 = 'Your reservation for Minday is now processing, wait for our staff to call your provided number for verification. Thank You for trusting us.';
